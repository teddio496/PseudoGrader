...
export default function FileUploader({ 
  ...
  return (
    <div className="flex h-screen gap-3 p-3">
      ...
      {/* File Preview Modal */}
      {selectedFile && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 flex-grow w-1/2" onClick={() => setSelectedFile(null)}>
          <div className="rounded-lg w-full max-w-4xl bg-[#222222] p-4" onClick={e => e.stopPropagation()}>
